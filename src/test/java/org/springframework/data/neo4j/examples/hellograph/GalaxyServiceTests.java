...
public class GalaxyServiceTests {
    ...
    public void shouldReachMarsFromEarth() {
        ...
        World venus = galaxyService.findWorldByName("Venus");
        World mercury = galaxyService.findWorldByName("Mercury");

        assertTrue(mars.canBeReachedFrom(earth));
        assertTrue(mars.canBeReachedFrom(mercury));
        assertTrue(mercury.canBeReachedFrom(earth));
